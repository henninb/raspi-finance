    ...
    return (
      <div>
        ...
        <Dialog open={this.state.open} onClose={this.handleClose} aria-labelledby="form-dialog-title">
          ...
          <div>
            <TextField autoFocus label="accountNameOwner" required id="accountNameOwner" type="text" placeholder="account accountNameOwner..." defaultValue="" onKeyDown={this.validateText} margin="dense" fullWidth />
            <TextField autoFocus label="accountType" required id="accountType" type="text" placeholder="account accountType..." defaultValue="credit" onKeyDown={this.validateText} margin="dense" fullWidth />
            <TextField autoFocus label="activeStatus" required id="activeStatus" type="text" placeholder="account activeStatus..." defaultValue="Y" onKeyDown={this.validateText} margin="dense" fullWidth />
            <TextField autoFocus label="moniker" required id="moniker" type="text" placeholder="account moniker..." defaultValue="0000" onKeyDown={this.validateText} margin="dense" fullWidth />
          </div>
     </DialogContent>
          <DialogActions>
